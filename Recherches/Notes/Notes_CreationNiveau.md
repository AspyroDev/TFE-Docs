...
### Idée N°1 : Le ticket de courses

#### Scénario général du niveau

*000100* - Un enfant est chez lui. 
*000200* - Il réalise une activité dans sa chambre (faire ses devoirs, jouer, etc.).  
*000300* - Un de ses parents l'appelle. 
*000400* - Il a besoin de l'aide de l'enfant.  
*000500* - En effet, il reste plusieurs tâches à faire avant le repas du soir, repas pour lequel de la famille est attendue.  

*001100* - Parmi ces tâches, il faut encore aller faire les courses. C'est la mission que le parent donne à l'enfant.  
*001200* - Pour cela, il lui donne une liste de course et lui indique le nom et la direction du magasin dans lequel se rendre.

*002100* - Notre joueur commence à incarner l'enfant.  
*002200* - La première étape de la mission est de se retrouver dans les rues du village afin d'atteindre le magasin indiqué par le parent.

*003100* - Une fois le magasin atteint, un couple sort avec ses courses. 
*003200* - Le joueur entend la discussion : le couple se dit que c'est quand même bien dommage que la caisse automatique du magasin soit en panne. 
*003300* - Le couple s'éloigne, et 
*003400* - le joueur récupère le contrôle de l'enfant pour rentrer dans le magasin.

*004100* - La deuxième étape de la mission est de récolter dans le magasin les différents éléments repris sur la liste de courses en quantités suffisantes.  
*004200* - Pour cela, il est nécessaire de se balader dans le magasin à la recherche des différents rayons.  
*004300* - Dans chacun des rayons, un certain nombre de produits sont disponibles. 
*004400* - Il faut interagir avec ces rayons pour pouvoir récolter les objets nécessaires à la complétion de la quête.

*005100* - Une fois les objets contenus sur la liste de courses récupérés, 
*005200* - notre joueur doit se rendre en direction de la caisse.  
*005300* - Le caisser, gérant du magasin, accueille le joueur et 
*005400* - s'excuse du fait que la caisse automatique soit en panne. 
*005500* - Il explique qu'il doit donc réaliser le ticket à la main, ce qui prend plus de temps.  

*006100* - Malheureusement, il reçoit un appel important (certainement le technicien de la caisse automatique qui appelle). 
*006200* - Il vous confie alors la mission de rédiger le ticket de caisse à sa place 
*006300* - pendant qu'il répond à l'appel. 
*006400* - Son excuse : ça prendra moins de temps que d'attendre qu'il finisse son appel !

*007100* - L'écran transitionne donc vers la scène de création du ticket. 
*007200* - C'est dans cette scène qu'a lieu le jeu en lien avec la leçon du niveau.

*008100* - Une fois le mini-jeu validé, la scène de création du ticket se ferme, 
*008200* - et le patron du magasin revient. 
*008300* - Il sera le juge du résultat du ticket de caisse.  
*008400* - Si le joueur se trompe, le patron aide l'enfant à corriger le ticket de caisse 
*008500* - et lui fait un rappel des connaissances nécessaires pour valider la mission. Il redonne la leçon.

*009100* - Il laisse ensuite le choix à l'enfant incarné par le joueur la possibilité de recommencer l'exercice avec le ticket de caisse du client suivant. 
*009200* - Soit l'enfant accepte, et dans ce cas il s'écarte légèrement 
*009300* - pour laisser passer le client suivant avant 
*009400* - de retransitionner vers la scène de création du ticket, 
*009500* - soit l'enfant refuse et 
*009600* - passe à la partie suivante de la mission.

*010100* - La dernière partie de la mission est pour l'enfant de rentrer chez lui pour apporter les courses à son parent.
*010200* - Arrivé chez lui, le parent demande à l'enfant comment se sont passées les courses et 
*010300* - on passe à la scène de résultat.

## To-Do List

- À quoi ressemble la maison du joueur ? --> Voir fichier *Schemas/MaisonJoueur_niveau1.drawio*
- À quoi ressemble la ville ? --> Voir fichier *Schemas/PlanDeVille_niveau1.drawio*
- À quoi ressemble le magasin ? --> Voir fichier *Schemas/Epicerie_niveau1.drawio*
- À quoi ressemble le joueur ?
- À quoi ressemble le parent du joueur ?
- À quoi ressemble le couple de clients ?
- À quoi ressemble le gérant du magasin ?